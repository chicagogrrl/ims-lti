...
[LTI 1.1 Introduction](http://www.imsglobal.org/LTI/v1p1p1/ltiIMGv1p1p1.html#_Toc330273022)
...
isn't used twice with the same timestamp. [Read the LTI documentation on OAuth](http://www.imsglobal.org/LTI/v1p1p1/ltiIMGv1p1p1.html#_Toc330273029).

### Tool Provider
As a TP your app will receive a POST request with a bunch of
[LTI launch data](http://www.imsglobal.org/LTI/v1p1p1/ltiIMGv1p1p1.html#_Toc330273026)
and it will be signed with OAuth using a key/secret that both the TP and TC share.
This is covered in the [LTI security model](http://www.imsglobal.org/LTI/v1p1p1/ltiIMGv1p1p1.html#_Toc330273027)
...
[launch data](http://www.imsglobal.org/LTI/v1p1p1/ltiIMGv1p1p1.html#_Toc330273026)
...
the TC. This is documented in the LTI docs [here](http://www.imsglobal.org/LTI/v1p1p1/ltiIMGv1p1p1.html#_Toc330273032).
